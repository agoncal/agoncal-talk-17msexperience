...
@Configuration
@EnableMongoRepositories("org.agoncal.talk.msexperience.demo03.bookapi.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("org.agoncal.talk.msexperience.demo03.bookapi.config.dbmigrations");
