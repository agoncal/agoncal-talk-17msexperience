...
```
$ docker image tag bookapi agoncal/bookapi
$ docker push agoncal/bookapi
$ docker image tag bookweb agoncal/bookweb
$ docker push agoncal/bookweb
$ docker image tag numberapi agoncal/numberapi
$ docker push agoncal/numberapi
```
